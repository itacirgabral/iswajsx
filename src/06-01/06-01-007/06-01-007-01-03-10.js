...
const SvgComponent = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  d: "M9 0v3L2.656 14 12 30.219V31c-1.49 0-2.51-2-4-2H7c-1.49 0-2.51 2-4 2H1v2h2c1.49 0 2.51-2 4-2h1c1.49 0 2.51 2 4 2h2v-3.313L4.937 14l6.375-11H26V0H9z"
}), /*#__PURE__*/React.createElement("path", {
  d: "M.924 17.054l1 1.732C.011 19.89-.532 22.53.71 24.683c1.243 2.152 3.801 3.001 5.714 1.897l1 1.732.866-.5-6.5-11.258-.866.5zm1.75 3.03l3 5.197c-1.195.69-2.836.087-3.665-1.348-.828-1.435-.53-3.158.665-3.848z"
}));
