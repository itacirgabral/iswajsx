...
const SvgComponent = (props) => (
  <svg width={22} height={26} {...props}>
    <path d="M8 7v19h1V7H8zM13 7v19h1V7h-1z" />
    ...
    <path
      ...
      fill="#fff"
    />
    <path d="M17.678 13.828a9 9 0 01-12.728 0l.707-.707a8 8 0 0011.314 0l1.414-1.414.707.707-1.414 1.414zM7.778 11H0v7.778L7.778 11zM18 7H4l7-7 7 7z" />
  </svg>
);
