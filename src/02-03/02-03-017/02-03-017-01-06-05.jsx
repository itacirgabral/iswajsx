...
const SvgComponent = (props) => (
  <svg width={21} height={36} {...props}>
    <path d="M12 29V0h1v29h-1zM3 29l7 7 7-7h-2.844L10 33.156 5.844 29H3zM21 16.219V24h-7.781l1-1H20v-5.781l1-1z" />
    ...
    <path d="M7 29V0h1v29H7zM21 5.219V13h-7.781l1-1H20V6.219l1-1z" />
