...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path
      ...
      fill="#fff"
    />
    <path d="M14.002 18.998H2.998L8.5 24.5l5.502-5.502zm-2.408.994L8.5 23.086l-3.071-3.072 6.165-.022zM0 9.9V0h9.9L0 9.9zm1.016-2.431L7.47 1.016H1.016V7.47z" />
    <path
      d="M1.016 7.469V1.016H7.47L1.016 7.47zM11.594 19.992l-6.165.022L8.5 23.086l3.094-3.094z"
      fill="#fff"
    />
  </svg>
);
