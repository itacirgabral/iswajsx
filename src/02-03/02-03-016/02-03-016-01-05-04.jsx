...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path
      ...
      fill="#fff"
    />
    <path d="M10.998 17.998h11.004L16.5 23.5l-5.502-5.502zm2.408.994l3.094 3.094 3.071-3.072-6.165-.022zM0 14.1V24h9.9L0 14.1zm1.016 2.431l6.453 6.453H1.016V16.53z" />
    <path
