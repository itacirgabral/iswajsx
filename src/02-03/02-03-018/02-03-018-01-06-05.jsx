...
const SvgComponent = (props) => (
  <svg width={22} height={36} {...props}>
    <path d="M13 29V0h1v29h-1zM4 29l7 7 7-7h-2.844L11 33.156 6.844 29H4zM22 16.219V24h-7.781l1-1H21v-5.781l1-1z" />
    ...
    <path d="M8 29V0h1v29H8zM0 5.219V13h7.781l-1-1H1V6.219l-1-1z" />
