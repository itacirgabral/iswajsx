...
const SvgComponent = (props) => (
  <svg width={22} height={36} {...props}>
    <path d="M4.156 7l7-7 7 7h-2.843l-4.157-4.156L7 7H4.156zM13.156 7v29h1V7h-1zM0 11.219V19h7.781l-1-1H1v-5.781l-1-1z" />
    ...
    <path d="M8.156 7v29h1V7h-1zM22 22.219V30h-7.781l1-1H21v-5.781l1-1z" />
    ...
    <path d="M9.156 7v29h4V7h-4z" fill="#fff" />
  </svg>
);
