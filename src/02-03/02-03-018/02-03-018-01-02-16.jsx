...
const SvgComponent = (props) => (
  <svg width={28} height={30} {...props}>
    ...
    <path
      ...
      fill="#fff"
    />
    <path d="M19.002 23.998H7.998L13.5 29.5l5.502-5.502zm-2.408.994L13.5 28.086l-3.071-3.072 6.165-.022z" />
    <path d="M16.594 24.992l-6.165.022 3.071 3.072 3.094-3.094z" fill="#fff" />
  </svg>
);
