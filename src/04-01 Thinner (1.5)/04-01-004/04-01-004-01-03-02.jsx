...
const SvgComponent = (props) => (
  <svg width={35} height={45} {...props}>
    ...
    <path
      ...
      fill="#fff"
    />
    <path d="M21.313 2.125l-6.188 6.188.688.687L22 2.812l-.688-.687zM8.188 0L2 6.188l.719.687L8.875.687 8.187 0z" />
    <path
      d="M8.875.688L2.719 6.875l1.406 1.438 6.188-6.188L8.874.687z"
      fill="#fff"
    />
    <path d="M10.313 2.125L4.125 8.313 4.813 9 11 2.812l-.688-.687zM30.188 0L24 6.188l.719.687L30.875.687 30.187 0z" />
    <path
