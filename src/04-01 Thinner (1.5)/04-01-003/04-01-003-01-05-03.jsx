...
const SvgComponent = (props) => (
  <svg width={35} height={48} {...props}>
    ...
    <path d="M24 9v1h-6V9h6zM24 12v1h-6v-1h6zM11 5l5-5 .719.719L12.437 5l4.282 4.281L16 10l-5-5z" />
    <path d="M15 3v1h6V3h-6zM15 6v1h6V6h-6zM11 17l5-5 .719.719L12.437 17l4.282 4.281L16 22l-5-5z" />
    <path d="M15 15v1h6v-1h-6zM15 18v1h6v-1h-6z" />
  </svg>
);
