...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path d="M17.5 21c-2.485 0-4.5 1.79-4.5 4s2.015 4 4.5 4 4.5-1.79 4.5-4-2.015-4-4.5-4zm0 2c1.38 0 2.5.895 2.5 2s-1.12 2-2.5 2-2.5-.895-2.5-2 1.12-2 2.5-2z" />
  </svg>
);
