...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path d="M11.531 28.781L10 27.5c1.905-2.769 4.568-4.5 7.5-4.5 2.932 0 5.595 1.731 7.5 4.5l-1.531 1.281C21.933 26.451 19.835 25 17.5 25c-2.335 0-4.433 1.45-5.969 3.781z" />
  </svg>
);
