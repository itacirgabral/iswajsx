...
const SvgComponent = (props) => (
  <svg width={35} height={35} {...props}>
    ...
    <path d="M10 25v2h4.5v-2H10zm10.5 0v2H25v-2h-4.5zM15.5 25v1a2 2 0 004 0v-1h-4z" />
    <path d="M17.5 31c-2.21 0-4-2.239-4-5v-1h1v1a3 3 0 006 0v-1h1v1c0 2.761-1.79 5-4 5z" />
  </svg>
);
