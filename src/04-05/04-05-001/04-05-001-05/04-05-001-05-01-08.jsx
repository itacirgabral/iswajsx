...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path d="M20.903 26.989c.096-.165.239-.312.31-.486.195-.482.309-.991.309-1.503 0-.512-.114-1.021-.31-1.503a4.014 4.014 0 00-.884-1.325 4.014 4.014 0 00-1.325-.884 4.012 4.012 0 00-1.503-.31c-.512 0-1.021.114-1.503.31-.174.07-.321.213-.486.31l5.392 5.39z" />
  </svg>
);
