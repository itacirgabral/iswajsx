...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path d="M20.328 27.828c.245-.244.429-.532.597-.817l-1.127-1.127c-1.27-1.27-1.698-3.062-1.348-4.751a3.962 3.962 0 00-4.817 4.817c1.689-.35 3.48.078 4.75 1.348l1.128 1.127c.285-.168.573-.352.817-.597z" />
  </svg>
);
