...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path d="M14.672 27.828c.244.245.532.429.817.597l1.127-1.127c1.27-1.27 3.062-1.698 4.751-1.348a3.962 3.962 0 00-4.817-4.817c.35 1.689-.078 3.48-1.348 4.75l-1.127 1.128c.168.285.352.573.597.817z" />
  </svg>
);
