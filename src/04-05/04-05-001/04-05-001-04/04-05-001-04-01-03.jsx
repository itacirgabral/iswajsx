...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path d="M13.5 25c0 .346.074.68.156 1h1.594c1.797 0 3.366.964 4.313 2.406a3.962 3.962 0 000-6.812C18.616 23.036 17.047 24 15.25 24h-1.594c-.082.32-.156.654-.156 1z" />
  </svg>
);
