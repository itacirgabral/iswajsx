...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path d="M13 24h9v2h-9zM24.719 20l-.719.719 2.125 2.156L24 25l2.125 2.125L24 29.281l.719.719 2.843-2.844L25.438 25l2.125-2.156L24.72 20zM10.281 20l.719.719-2.125 2.156L11 25l-2.125 2.125L11 29.281l-.719.719-2.844-2.844L9.563 25l-2.124-2.156L10.28 20z" />
  </svg>
);
