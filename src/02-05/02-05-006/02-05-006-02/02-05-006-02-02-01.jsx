...
const SvgComponent = (props) => (
  <svg width={40} height={19} {...props}>
    ...
    <path d="M20 15l-7-7h14l-7 7zm0-1.438L24.563 9h-9.125L20 13.563zM19 8h2V1h-2v7z" />
    <path d="M20 13.563L15.437 9h9.126L20 13.563z" fill="#fff" />
