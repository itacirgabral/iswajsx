...
const SvgComponent = (props) => (
  <svg width={28} height={32} {...props}>
    <path d="M18.1 32H28v-9.9l-2.01 2.011v5.878H20.11L18.101 32zM11 31l-5.5-5.5L11 20v1.414L6.914 25.5 11 29.586V31z" />
    ...
    <path
      ...
      fill="#fff"
    />
    <path d="M20 15a9 9 0 01-9 9v-1a8 8 0 008-8v-2h1v2zM18 6L12.5.5 7 6h1.414L12.5 1.914 16.586 6H18z" />
    ...
    <path d="M22.627 28.042L0 5.414 1.414 4l22.628 22.627-1.415 1.415z" />
  </svg>
);
