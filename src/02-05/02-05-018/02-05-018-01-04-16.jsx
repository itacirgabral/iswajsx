...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path d="M5 15a9 9 0 009-9h-1a8 8 0 01-8 8H3v1h2zM10 6L15.5.5 21 6H10zM0 10.9L9.9 1H0v9.9zM27 15c0 7.18-5.82 13-13 13v-1c6.627 0 12-5.373 12-12v-2h1v2z" />
    <path
      d="M26 15c0 6.627-5.373 12-12 12v-3a9 9 0 009-9v-2h3v2z"
      fill="#fff"
    />
    <path d="M5.373 4.958L28 27.586 26.586 29 3.958 6.373l1.415-1.415z" />
    <path d="M23 15a9 9 0 01-9 9v-1a8 8 0 008-8v-2h1v2zM14 20l-5.5 5.5L14 31V20z" />
  </svg>
);
