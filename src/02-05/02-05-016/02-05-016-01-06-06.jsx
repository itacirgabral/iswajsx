...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    <path d="M19 11.1V21H9.1l2.011-2.01h5.878V13.11L19 11.101zM13 0l5.5 5.5L13 11V9.586L17.086 5.5 13 1.414V0z" />
    ...
    <path d="M4 16a9 9 0 019-9v1a8 8 0 00-8 8v2H4v-2z" />
  </svg>
);
