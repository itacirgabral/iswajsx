...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    <path d="M9.9 19H0V9.1l2.01 2.011v5.878H7.89L9.899 19zM21 13l-5.5 5.5L10 13h1.414l4.086 4.086L19.586 13H21z" />
    ...
    <path d="M5 4a9 9 0 019 9h-1a8 8 0 00-8-8H3V4h2z" />
  </svg>
);
