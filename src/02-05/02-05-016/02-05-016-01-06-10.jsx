...
const SvgComponent = (props) => (
  <svg width={19} height={21} {...props}>
    <path d="M19 9.9V0H9.1l2.011 2.01h5.878V7.89L19 9.899zM13 21l5.5-5.5L13 10v1.414l4.086 4.086L13 19.586V21z" />
    ...
    <path d="M4 5a9 9 0 009 9v-1a8 8 0 01-8-8V3H4v2z" />
  </svg>
);
