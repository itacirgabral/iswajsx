...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    <path d="M11.1 19H21V9.1l-2.01 2.011v5.878H13.11L11.101 19zM0 13l5.5 5.5L11 13H9.586L5.5 17.086 1.414 13H0z" />
    ...
    <path d="M16 4a9 9 0 00-9 9h1a8 8 0 018-8h2V4h-2z" />
  </svg>
);
