...
const SvgComponent = (props) => (
  <svg width={43} height={20} {...props}>
    ...
    <path
      ...
      fill="#fff"
    />
    <path d="M30 5a6 6 0 000 12h3v-3h-3c-2.761 0-5-1.343-5-3a5 5 0 015-5h3V5h-3z" />
    <path d="M32 11l4.5 4.5L32 20v-9zm1 2.406v4.188l2.094-2.094L33 13.406z" />
    <path d="M33 13.406l2.094 2.094L33 17.594v-4.188z" fill="#fff" />
  </svg>
);
