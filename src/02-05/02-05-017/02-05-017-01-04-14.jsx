...
const SvgComponent = (props) => (
  <svg width={29} height={30} {...props}>
    ...
    <path d="M15 25a9 9 0 00-9-9v1a8 8 0 018 8v2h1v-2zM6 20L.5 14.5 6 9v11zM10.9 30L1 20.1V30h9.9zM28 16c0-7.18-5.82-13-13-13v1c6.627 0 12 5.373 12 12v2h1v-2z" />
    <path d="M27 16c0-6.627-5.373-12-12-12v3a9 9 0 019 9v2h3v-2z" fill="#fff" />
    <path d="M24 16a9 9 0 00-9-9v1a8 8 0 018 8v2h1v-2zM15 11L9.5 5.5 15 0v11z" />
  </svg>
);
