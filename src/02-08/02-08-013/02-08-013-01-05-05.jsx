...
const SvgComponent = (props) => (
  <svg width={24} height={22} {...props}>
    ...
    <path d="M16.5 13.5L12 18h9l-4.5-4.5zm0 .969l2.813 2.844h-5.625l2.812-2.844z" />
    <path d="M23 0v17c0 1.657-.895 3-2 3a2 2 0 01-2-2h-5a4 4 0 004 4h1a5 5 0 005-5V0h-1z" />
    <path d="M16.5 14.469l-2.813 2.844h5.626L16.5 14.469z" fill="#fff" />
  </svg>
);
