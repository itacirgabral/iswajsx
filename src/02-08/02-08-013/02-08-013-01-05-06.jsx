...
const SvgComponent = (props) => (
  <svg width={24} height={22} {...props}>
    <path d="M19.5 13.5L24 18h-9l4.5-4.5zm0 .969l-2.813 2.844h5.625L19.5 14.469z" />
    <path d="M13 0v17c0 1.657.895 3 2 3a2 2 0 002-2h5a4 4 0 01-4 4h-1a5 5 0 01-5-5V0h1z" />
    <path d="M19.5 14.469l2.813 2.844h-5.625l2.812-2.844z" fill="#fff" />
