...
const SvgComponent = (props) => (
  <svg width={23} height={22} {...props}>
    <path d="M18.5.5L23 5h-9L18.5.5zm0 .969l-2.813 2.843h5.626L18.5 1.47zM19 5v13a4 4 0 01-4 4 5 5 0 01-5-5h5c0 1.657.672 3 1.5 3s1.5-1.343 1.5-3V5h1z" />
    <path d="M18.5 1.469l2.813 2.843h-5.625L18.5 1.47z" fill="#fff" />
