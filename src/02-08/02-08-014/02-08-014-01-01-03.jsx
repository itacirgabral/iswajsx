...
const SvgComponent = (props) => (
  <svg width={35} height={32} {...props}>
    ...
    <path d="M2.373 31.042l.707.707 20.506-20.506-.707-.707L2.373 31.042zM28.536 4.879l.707.707 4.242-4.243-.707-.707-4.242 4.243zM9.9 16H0v9.9L9.9 16z" />
