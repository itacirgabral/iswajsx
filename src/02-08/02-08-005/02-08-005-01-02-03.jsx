...
const SvgComponent = (props) => (
  <svg width={27} height={20} {...props}>
    ...
    <path d="M.222 13H8V5.222L.222 13zm2.43-1.016l4.332-4.331v4.33H2.653zM5.879 18.657l.707.707L24.97.979l-.708-.707L5.88 18.657z" />
    <path d="M2.653 11.984h4.33V7.653l-4.33 4.33z" fill="#fff" />
  </svg>
);
