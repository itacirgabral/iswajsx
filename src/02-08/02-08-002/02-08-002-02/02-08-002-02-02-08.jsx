...
const SvgComponent = (props) => (
  <svg width={40} height={21} {...props}>
    <path d="M39.9 16H30V6.1l9.9 9.9zm-2.431-1.016L31.016 8.53v6.453h6.453z" />
    ...
    <path d="M37.469 14.984h-6.453V8.53l6.453 6.453z" fill="#fff" />
  </svg>
);
