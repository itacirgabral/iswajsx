...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path
      ...
      fill="#fff"
    />
    <path d="M14.188 2.125l-.688.688L19.688 9l.687-.688-6.188-6.187zM5.813 0l-.688.688 6.156 6.187.719-.688L5.812 0z" />
    <path
      d="M5.125.688L3.687 2.125l6.188 6.188 1.406-1.438L5.125.687z"
      fill="#fff"
    />
    <path d="M3.688 2.125L3 2.813 9.188 9l.687-.688-6.188-6.187zM26.813 0l-.688.688 6.156 6.187.719-.688L26.812 0z" />
    <path
