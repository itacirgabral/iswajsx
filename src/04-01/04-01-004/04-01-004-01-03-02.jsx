...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path
      ...
      fill="#fff"
    />
    <path d="M21.813 2.125l-6.188 6.188.688.687L22.5 2.812l-.688-.687zM9.188 0L3 6.188l.719.687L9.875.687 9.187 0z" />
    <path
      d="M9.875.688L3.719 6.875l1.406 1.438 6.188-6.188L9.874.687z"
      fill="#fff"
    />
    <path d="M11.313 2.125L5.125 8.313 5.813 9 12 2.812l-.688-.687zM30.188 0L24 6.188l.719.687L30.875.687 30.187 0z" />
    <path
      d="M30.875.688l-6.156 6.187 1.406 1.438 6.188-6.188L30.875.687z"
      fill="#fff"
    />
    <path d="M32.313 2.125l-6.188 6.188.688.687L33 2.812l-.688-.687z" />
  </svg>
);
