...
const SvgComponent = (props) => (
  <svg width={35} height={35} {...props}>
    ...
    <path d="M17.5 21c-2.485 0-4.5 1.79-4.5 4s2.015 4 4.5 4 4.5-1.79 4.5-4-2.015-4-4.5-4zm0 1.5c1.657 0 3 1.12 3 2.5s-1.343 2.5-3 2.5-3-1.12-3-2.5 1.343-2.5 3-2.5z" />
  </svg>
);
