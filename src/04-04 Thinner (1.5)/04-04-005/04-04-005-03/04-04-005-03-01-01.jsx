...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path d="M17.5 18.5c-1.657 0-3 2.91-3 6.5s1.343 6.5 3 6.5 3-2.91 3-6.5-1.343-6.5-3-6.5zm0 1.5c.828 0 1.5 2.239 1.5 5s-.672 5-1.5 5-1.5-2.239-1.5-5 .672-5 1.5-5z" />
  </svg>
);
