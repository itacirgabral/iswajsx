...
const SvgComponent = (props) => (
  <svg width={15} height={19} {...props}>
    ...
    <path
      d="M7.844 1C7.562 1.047 7 1.25 7 2v2h3V2s0-1-1-1H8s-.063-.016-.156 0zm4 0c-.281.047-.844.25-.844 1v2h3V2s0-1-1-1h-1s-.063-.016-.156 0zM2 6v2H0v3h2v6h6v-6h7V8H8V6H2z"
      fill="#fff"
    />
    <path
