...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path d="M18 25.25v1.5h7v-1.5h-7zM12 25.25V26a2 2 0 004 0v-.75h-4z" />
    <path d="M10 25.25V27a4 4 0 108 0v-1.75h-1V27c0 1.38-1.343 2.5-3 2.5s-3-1.12-3-2.5v-1.75h-1z" />
  </svg>
);
