...
const SvgComponent = (props) => (
  <svg width={35} height={35} {...props}>
    ...
    <path d="M20.328 27.828c.18-.18.326-.393.464-.596l-2.165-2.166c-.922-.922-.066-3.91-.066-3.91a3.973 3.973 0 00-3.89 1.016 3.973 3.973 0 00-1.016 3.889s2.99-.856 3.911.066l2.166 2.165c.203-.138.416-.283.596-.464z" />
  </svg>
);
