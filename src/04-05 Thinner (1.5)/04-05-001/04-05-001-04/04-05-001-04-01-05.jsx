...
const SvgComponent = (props) => (
  <svg width={35} height={35} {...props}>
    ...
    <path d="M17.5 29c.255 0 .508-.048.75-.094v-3.062c0-1.304 2.719-2.813 2.719-2.813A3.973 3.973 0 0017.5 21a3.973 3.973 0 00-3.469 2.031s2.719 1.509 2.719 2.813v3.062c.242.046.495.094.75.094z" />
  </svg>
);
