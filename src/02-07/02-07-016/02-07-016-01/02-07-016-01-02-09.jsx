...
const SvgComponent = (props) => (
  <svg width={22} height={37} {...props}>
    <path d="M14 0l6 6-6 6V0zm1 2.406v7.188L18.563 6 15 2.406z" />
    ...
    <path d="M15 2.406L18.563 6 15 9.594V2.406z" fill="#fff" />
    <path d="M22 20v2H12v-2h10zM10 29v2H0v-2h10zM10 10v2H0v-2h10z" />
  </svg>
);
