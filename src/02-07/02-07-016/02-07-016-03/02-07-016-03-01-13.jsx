...
const SvgComponent = (props) => (
  <svg width={34} height={51} {...props}>
    <path d="M10 51V37l-7 7 7 7z" />
    ...
    <path d="M4 19a4 4 0 100 8 4 4 0 000-8zM30 33a4 4 0 100 8 4 4 0 000-8zM30 5a4 4 0 100 8 4 4 0 000-8z" />
  </svg>
);
