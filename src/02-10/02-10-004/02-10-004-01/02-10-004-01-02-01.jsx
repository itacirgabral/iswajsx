...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    <path d="M9 6l6 6H3l6-6zm0 1.406L5.437 11h7.125L9 7.406z" />
    ...
    <path d="M9 7.406L12.563 11H5.436L9 7.406z" fill="#fff" />
    <path d="M9 12l6 6H3l6-6zm0 1.406L5.437 17h7.125L9 13.406z" />
    <path d="M9 13.406L12.563 17H5.436L9 13.406z" fill="#fff" />
  </svg>
);
