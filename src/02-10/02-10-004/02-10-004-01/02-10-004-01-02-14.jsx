...
const SvgComponent = (props) => (
  <svg width={22} height={22} {...props}>
    <path d="M9 18h8.485L9 9.515V18zm.994-.994l.022-5.06 5.039 5.038-5.06.022z" />
    ...
    <path d="M9.994 17.006l5.06-.022-5.038-5.039-.022 5.06z" fill="#fff" />
    <path d="M13.243 13.757h8.485l-8.485-8.485v8.485zm.994-.994l.022-5.06 5.038 5.038-5.06.022z" />
    <path d="M14.237 12.763l5.06-.022-5.038-5.038-.022 5.06z" fill="#fff" />
  </svg>
);
