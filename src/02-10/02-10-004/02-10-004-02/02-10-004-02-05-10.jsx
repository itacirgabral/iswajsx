...
const SvgComponent = (props) => (
  <svg width={25} height={26} {...props}>
    <path d="M13 5H5.222L13 12.778V5zm-1.016 1.016v4.331l-4.331-4.33h4.33z" />
    ...
    <path d="M11.984 6.016H7.653l4.33 4.331v-4.33z" fill="#fff" />
    <path d="M9 9H1.222L9 16.778V9zm-1.016 1.016v4.331l-4.331-4.33h4.33z" />
    <path d="M7.984 10.016H3.653l4.33 4.331v-4.33z" fill="#fff" />
  </svg>
);
