...
const SvgComponent = (props) => (
  <svg width={21} height={20} {...props}>
    ...
    <path d="M3 10V2l8 8H3zM14 0c-1.791 0-3.57.696-4.938 2.063L6.22 5.219l1.375 1.375 2.875-3.125a4.978 4.978 0 017.062 0l2.063 2.312L21 4.375l-2.063-2.313A6.963 6.963 0 0014 0z" />
    <path d="M0 13V5l8 8H0z" />
  </svg>
);
