...
const SvgComponent = (props) => (
  <svg width={18} height={20} {...props}>
    ...
    <path d="M0 10h8L6.5 8.5h-5v-5L0 2v8zM11 0C9.209 0 7.43.696 6.062 2.063L3.22 5.219l1.375 1.375 2.875-3.125a4.978 4.978 0 017.062 0l2.063 2.312L18 4.375l-2.063-2.313A6.963 6.963 0 0011 0z" />
  </svg>
);
