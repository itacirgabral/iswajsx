...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    <path d="M10 10V8.5L6.5 5 10 1.5V0L5 5l5 5zM15 3a9 9 0 019 9v6h-1v-6a8 8 0 00-8-8h-5V3h5z" />
    <path d="M15 4a8 8 0 018 8v6h-2v-6a6 6 0 00-6-6h-5V4h5z" fill="#fff" />
    <path d="M15 6a6 6 0 016 6v6h-1v-6a5 5 0 00-5-5h-5V6h5zM5 18v-1.5L1.5 13 5 9.5V8l-5 5 5 5z" />
