...
const SvgComponent = (props) => (
  <svg width={26} height={24} {...props}>
    <path d="M26 14l-5 5-5-5h1.5l3.5 3.5 3.5-3.5H26zM23 9a9 9 0 00-9-9H8v1h6a8 8 0 018 8v5h1V9z" />
    <path d="M22 9a8 8 0 00-8-8H8v2h6a6 6 0 016 6v5h2V9z" fill="#fff" />
    <path d="M20 9a6 6 0 00-6-6H8v1h6a5 5 0 015 5v5h1V9zM18 19l-5 5-5-5h1.5l3.5 3.5 3.5-3.5H18z" />
