...
const SvgComponent = (props) => (
  <svg width={24} height={26} {...props}>
    <path d="M14 16v1.5l3.5 3.5-3.5 3.5V26l5-5-5-5zM9 23a9 9 0 01-9-9V8h1v6a8 8 0 008 8h5v1H9z" />
    <path d="M9 22a8 8 0 01-8-8V8h2v6a6 6 0 006 6h5v2H9z" fill="#fff" />
    <path d="M9 20a6 6 0 01-6-6V8h1v6a5 5 0 005 5h5v1H9zM19 8v1.5l3.5 3.5-3.5 3.5V18l5-5-5-5z" />
