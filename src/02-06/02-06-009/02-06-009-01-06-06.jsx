...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    <path d="M26 10l-5-5-5 5h1.5L21 6.5l3.5 3.5H26zM23 15a9 9 0 01-9 9H8v-1h6a8 8 0 008-8v-5h1v5z" />
    <path d="M22 15a8 8 0 01-8 8H8v-2h6a6 6 0 006-6v-5h2v5z" fill="#fff" />
    <path d="M20 15a6 6 0 01-6 6H8v-1h6a5 5 0 005-5v-5h1v5zM18 5l-5-5-5 5h1.5L13 1.5 16.5 5H18z" />
