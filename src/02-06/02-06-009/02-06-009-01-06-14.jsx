...
const SvgComponent = (props) => (
  <svg width={26} height={24} {...props}>
    <path d="M0 10l5-5 5 5H8.5L5 6.5 1.5 10H0zM3 15a9 9 0 009 9h6v-1h-6a8 8 0 01-8-8v-5H3v5z" />
    <path d="M4 15a8 8 0 008 8h6v-2h-6a6 6 0 01-6-6v-5H4v5z" fill="#fff" />
    <path d="M6 15a6 6 0 006 6h6v-1h-6a5 5 0 01-5-5v-5H6v5zM8 5l5-5 5 5h-1.5L13 1.5 9.5 5H8z" />
