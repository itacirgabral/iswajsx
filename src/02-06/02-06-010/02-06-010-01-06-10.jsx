...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    <path d="M27 14l-5 5-5-5h1.5l3.5 3.5 3.5-3.5H27zM24 9a9 9 0 00-9-9H9v1h6a8 8 0 018 8v5h1V9z" />
    <path d="M23 9a8 8 0 00-8-8H9v2h6a6 6 0 016 6v5h2V9z" fill="#fff" />
    <path d="M21 9a6 6 0 00-6-6H9v1h6a5 5 0 015 5v5h1V9zM5 3v1.5L1.5 8 5 11.5V13L0 8l5-5z" />
