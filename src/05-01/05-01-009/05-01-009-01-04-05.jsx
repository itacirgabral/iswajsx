...
const SvgComponent = (props) => (
  <svg width={35} height={48} {...props}>
    ...
    <path d="M16.75 7h1.5V0h-1.5v7zM9.5 12a3 3 0 110-6 3 3 0 010 6z" />
    <path d="M8.75 7h1.5V0h-1.5v7zM25.5 12a3 3 0 110-6 3 3 0 010 6z" />
    <path d="M24.75 7h1.5V0h-1.5v7z" />
  </svg>
);
