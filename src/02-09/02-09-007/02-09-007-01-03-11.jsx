...
const SvgComponent = (props) => (
  <svg width={19} height={45} {...props}>
    ...
    <path d="M6 23L.5 28.5 6 34v-2l-3.5-3.5L6 25v-2zM14 0v14h-1V0h1zm0 17v20h-1V17h1zm0 23v5h-1v-5h1z" />
    ...
    <path d="M6 10L.5 15.5 6 21v-2l-3.5-3.5L6 12v-2zM10 0v14H9V0h1zm0 17v20H9V17h1zm0 23v5H9v-5h1z" />
  </svg>
);
