...
const SvgComponent = (props) => (
  <svg width="1em" height="1em" {...props}>
    ...
    <path d="M9 0h1v29H9V0zM0 19v8h8l-8-8zm1 2.438L5.563 26H1v-4.563zM13 0h1v29h-1V0z" />
    ...
    <path
      d="M10 0h3v29h-3V0zM1 10.438V15h4.563L1 10.437zM1 21.438V26h4.563L1 21.437z"
      fill="#fff"
    />
  </svg>
);
