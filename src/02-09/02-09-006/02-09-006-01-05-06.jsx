...
const SvgComponent = (props) => (
  <svg width={26} height={24} {...props}>
    <path d="M26 11l-4.5-4.5L17 11h9zm-2.438-1h-4.125L21.5 7.906 23.563 10zM12 24c5.523 0 10-4.477 10-10v-3h-1v3a9 9 0 01-9 9H6v1h6z" />
    <path d="M23.563 10L21.5 7.906 19.437 10h4.125z" fill="#fff" />
