...
const SvgComponent = (props) => (
  <svg width={26} height={24} {...props}>
    ...
    <path d="M6 19l4.5 4.5L15 19H6zm2.438 1h4.124L10.5 22.094 8.437 20zM20 6c-5.523 0-10 4.477-10 10v3h1v-3a9 9 0 019-9h6V6h-6z" />
    <path d="M8.438 20l2.062 2.094L12.563 20H8.436z" fill="#fff" />
  </svg>
);
