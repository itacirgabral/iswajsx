...
const SvgComponent = (props) => (
  <svg width={24} height={11} {...props}>
    ...
    <path d="M23.342 6.496l-3.536 3.536-.707-.707 2.828-2.829L19.1 3.668l.707-.707 3.536 3.535zM16.182 4.817A4.006 4.006 0 0019.01 6.01V4.994a3.009 3.009 0 01-3.005-3.005V0l-.994-.022-.022 2.01c0 1.105.47 2.105 1.193 2.83z" />
    <path d="M14.768 6.231A5.99 5.99 0 0019.01 8V6.983a4.99 4.99 0 01-4.994-4.994V0H13v1.989a5.99 5.99 0 001.768 4.242z" />
    <path d="M14 2a5 5 0 005 5V6a4 4 0 01-4-4V0h-1v2z" fill="#fff" />
  </svg>
);
