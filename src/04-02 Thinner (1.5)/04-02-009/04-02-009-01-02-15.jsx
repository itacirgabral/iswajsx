...
const SvgComponent = (props) => (
  <svg width={17} height={12} {...props}>
    ...
    <path
      ...
      fill="#fff"
    />
    <path d="M17 0h-5v1h4v4h1V0zM13.125 6.25c0-1.024.375-2.063 1.156-2.844l.719.719a3.009 3.009 0 000 4.25l1.406 1.406-.687.719-1.438-1.406a4.006 4.006 0 01-1.156-2.844z" />
    <path d="M11.125 6.25A5.99 5.99 0 0112.875 2l.719.719a4.99 4.99 0 000 7.062L15 11.187l-.719.72-1.406-1.407a5.99 5.99 0 01-1.75-4.25z" />
    <path
