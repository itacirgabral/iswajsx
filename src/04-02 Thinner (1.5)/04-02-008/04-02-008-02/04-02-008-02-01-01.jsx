...
const SvgComponent = (props) => (
  <svg width={35} height={35} {...props}>
    <path d="M7 11v4h1v-4H7zM13 11v4h1v-4h-1z" />
    <path d="M7.5 8L4 11.5l.719.688L7.5 9.438l3 2.968 3-2.969 2.781 2.75L17 11.5 13.5 8l-3 3-3-3zM21 11v4h1v-4h-1zM27 11v4h1v-4h-1z" />
